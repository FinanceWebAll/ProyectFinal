...
function EvaluacionInstrumentos() {
  ...
  const guardarOperacionEnHistorial = (tcea) => {
    const nuevaOperacion = {
      descripcion: 'Evaluación de Instrumentos Financieros',
      capital: parseFloat(capital),
      tasaAnual: parseFloat(tasaAnual),
      tcea: parseFloat(tcea),
  ...
  const calcularTCEA = () => {
    ...
    guardarOperacionEnHistorial(tcea.toFixed(2));
  };
